<x-layout title="Lançamento de Faltas em Lote	">
<form class="needs-validation mb-3" action="{{route('frequencia.faltas')}}" method="post" target="_blanck">
        @csrf
        <div class="row g-3 border rounded-3 pb-3 user-select-none">
            ...
            <div class="col-sm-2 align-self-end text-end ">
                <button class="btn btn-outline-primary" type="submit" id="btnNovo" disabled>Gerar Dados</button>
            </div>
        </div>
    </form>
